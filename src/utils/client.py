...
async def create_client(
    ...
    session = primp.AsyncClient(impersonate="chrome_133", verify=skip_ssl_verification, follow_redirects=True)
...
async def create_curl_client(
    proxy: str, verify_ssl: bool = True
